...
> Authors: [Ziggy](https://github.com/ziggyhuang) and [Shuo](https://github.com/SS47816) and [Grooup-11-Zhong Zeren](https://github.com/HardyPavel)
>
Our team implemented trajectory tracking using the Pure Pursuit algorithm. The core idea of this algorithm is to calculate a virtual target point, which is located on the predefined trajectory in front of the robot. The robot then adjusts its direction to follow this virtual target point. By continuously moving this virtual target point and adjusting the direction, the robot can travel along the predetermined path. We modified and improved the original code, and adjusted various parameters to optimize the tracking performance.
